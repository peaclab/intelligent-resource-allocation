...
class M100Preprocessor:
    def __init__(self, directory='/projectnb/peaclab-mon/boztop/resource-allocation/datasets/m100/21_12_job_table/metric=job_info_marconi100/a_0.parquet'):
        self.directory = directory
        self.train_features = [ 'group_id',  'partition', 'priority', 'user_id','time_limit_sec']
    ...
    def preprocess_data(self):
        ...
        df = pd.read_parquet(self.directory)
        ...
        df['time_limit_sec'] = df['time_limit_str'].apply(TimeConverter.convert_time_limit_to_seconds)
